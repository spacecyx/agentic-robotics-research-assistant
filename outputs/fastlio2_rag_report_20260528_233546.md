...
LOCAL_FAKE_SUMMARY weak path unique

## Technical Critique

LOCAL_FAKE_CRITIQUE weak path unique

## Retrieval Quality Warnings

- Conditional Branch Decision: proceed_with_warning
- Fallback Reason: weak_retrieval_evidence_after_retry
- Retrieval Quality: weak
- Recommended Action: expand_query
- Reasons: low_top_score, low_avg_score, missing_experiment_or_result_section, missing_dataset_or_metric_tags
